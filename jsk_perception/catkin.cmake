...
find_package(catkin REQUIRED COMPONENTS imagesift sensor_msgs geometry_msgs cv_bridge image_geometry image_transport driver_base dynamic_reconfigure pcl_ros eigen roscpp)
find_package(OpenCV REQUIRED)
find_package(Boost REQUIRED COMPONENTS filesystem system signals)

# Dynamic reconfigure support
generate_dynamic_reconfigure_options(cfg/camshiftdemo.cfg cfg/edge_detector.cfg cfg/hough_lines.cfg cfg/matchtemplate.cfg cfg/point_pose_extractor.cfg cfg/rectangle_detector.cfg)
...
target_link_libraries(point_pose_extractor     ${catkin_LIBRARIES} ${OpenCV_LIBRARIES} ${Boost_LIBRARIES} /opt/ros/hydro/lib/librospack.so)
...
add_dependencies(point_pose_extractor     ${PROJECT_NAME}_gencfg ${PROJECT_NAME}_gencpp)
